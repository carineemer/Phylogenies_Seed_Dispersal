...
m1<-lm(mean_ED_site~def_mean, data = int_ed_def_site)
...
#sum_int_ED_site[10,] # intervales 47681.49
#dif_EDi<-mean_sub_intervales - sum_int_ED_site[21,2] #ufrj -the smallest area 921.8685

##### HISTOGRAMS FOR BODYMASS OF INTERVALES AND UFRJ

hist((bm_commu[bm_commu$site=="intervales",]$Frug_Body_Mass))
hist((bm_commu[bm_commu$site=="ufrj",]$Frug_Body_Mass))

hist((bm_commu[bm_commu$site=="botelho",]$Frug_Body_Mass))
hist((bm_commu[bm_commu$site=="pira",]$Frug_Body_Mass))
